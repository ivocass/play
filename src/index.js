...
function integerSquareRoot(input) {
  ...
  let rootLeft = badSqrt.slice(0, Math.min(maxLength, 14)).replace('.', '');
  ...
  while (zeroesAmount > 0) {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      if (zeroesAmount === 1 && validate(potentialRoot, input)) {
      ...
      // console.log('log', potentialRoot, rootLeft, i, zeroesAmount);
    }
...
// let res = multiply('1732', '1732');

// let res = integerSquareRoot('3000000');

// let res = greaterThan(
//   // square('152421548093487868711992623730429930751178496967'),
//   square('152421548093487870000000000000000000000000000000'),
//   // square('152' + '0'.repeat(45)),
//   '23232328323215435345345345343458098856756556809400840980980980980809092343243243243243098799634'
// );
// let sq = square('152421548093487868711992623730429930751178496968');
// let res = lessThan(
//   sq,
//   '23232328323215435345345345343458098856756556809400840980980980980809092343243243243243098799634'
// );
// let res = greaterThan(
//   square('904742713771100000000000000'),
//   '818559378121966912256787339285830365925369143984475356'
// );
// let res = square('904742713771100000000000000');
// let res = lessThan(
//   '12323309809809534545458098709854808654685691283927996159688908958051880469765875196900',
